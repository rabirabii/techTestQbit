...
} from "./chunk-VOCHFWRG.js";
import "./chunk-6BKLQ22S.js";
import {
  $6ed0406888f73fc4$export$c7b2cbe3552a0d05,
  _extends
} from "./chunk-A6RD3FLF.js";
import {
  require_react
...
var $57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeScrollArea, type = "hover", dir, scrollHideDelay = 600, ...scrollAreaProps } = props;
  const [scrollArea, setScrollArea] = (0, import_react2.useState)(null);
  const [viewport, setViewport] = (0, import_react2.useState)(null);
  const [content, setContent] = (0, import_react2.useState)(null);
  const [scrollbarX, setScrollbarX] = (0, import_react2.useState)(null);
  const [scrollbarY, setScrollbarY] = (0, import_react2.useState)(null);
  const [cornerWidth, setCornerWidth] = (0, import_react2.useState)(0);
  const [cornerHeight, setCornerHeight] = (0, import_react2.useState)(0);
  const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react2.useState)(false);
  const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react2.useState)(false);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setScrollArea(node)
  );
  const direction = $f631663db3294ace$export$b39126d51d94e6f3(dir);
  return (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaProvider, {
...
var $57acba87d6e25586$export$a21cbf9f11fca853 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $57acba87d6e25586$export$2fabd85d0eba3c57 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return context.type === "hover" ? (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarHover, _extends({}, scrollbarProps, {
    ref: forwardedRef,
    forceMount
  })) : context.type === "scroll" ? (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarScroll, _extends({}, scrollbarProps, {
    ref: forwardedRef,
    forceMount
  })) : context.type === "auto" ? (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarAuto, _extends({}, scrollbarProps, {
    ref: forwardedRef,
    forceMount
  })) : context.type === "always" ? (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarVisible, _extends({}, scrollbarProps, {
    ref: forwardedRef
  })) : null;
});
...
var $57acba87d6e25586$var$ScrollAreaScrollbarHover = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { forceMount, ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  ...
  }, (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarAuto, _extends({
    "data-state": visible ? "visible" : "hidden"
  }, scrollbarProps, {
    ref: forwardedRef
  })));
});
var $57acba87d6e25586$var$ScrollAreaScrollbarScroll = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { forceMount, ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  const isHorizontal = props.orientation === "horizontal";
  ...
  }, (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarVisible, _extends({
...
var $57acba87d6e25586$var$ScrollAreaScrollbarAuto = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  const { forceMount, ...scrollbarProps } = props;
  const [visible, setVisible] = (0, import_react2.useState)(false);
  const isHorizontal = props.orientation === "horizontal";
...
var $57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  const thumbRef = (0, import_react2.useRef)(null);
  const pointerOffsetRef = (0, import_react2.useRef)(0);
  ...
  if (orientation === "horizontal") return (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarX, _extends({}, commonProps, {
    ref: forwardedRef,
  ...
  if (orientation === "vertical") return (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarY, _extends({}, commonProps, {
    ref: forwardedRef,
    onThumbPositionChange: () => {
      if (context.viewport && thumbRef.current) {
...
var $57acba87d6e25586$var$ScrollAreaScrollbarX = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = (0, import_react2.useState)();
  const ref = (0, import_react2.useRef)(null);
  ...
  return (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarImpl, _extends({
...
var $57acba87d6e25586$var$ScrollAreaScrollbarY = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = (0, import_react2.useState)();
  const ref = (0, import_react2.useRef)(null);
...
var $57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeScrollArea, sizes, hasThumb, onThumbChange, onThumbPointerUp, onThumbPointerDown, onThumbPositionChange, onDragScroll, onWheelScroll, onResize, ...scrollbarProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, __scopeScrollArea);
  const [scrollbar, setScrollbar] = (0, import_react2.useState)(null);
  const composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setScrollbar(node)
  );
  const rectRef = (0, import_react2.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react2.useRef)("");
  const viewport = context.viewport;
  ...
  (0, import_react2.useEffect)(handleThumbPositionChange, [
    sizes,
    handleThumbPositionChange
  ]);
  $57acba87d6e25586$var$useResizeObserver(scrollbar, handleResize);
  $57acba87d6e25586$var$useResizeObserver(context.content, handleResize);
  return (0, import_react2.createElement)($57acba87d6e25586$var$ScrollbarProvider, {
    scope: __scopeScrollArea,
    scrollbar,
    hasThumb,
  ...
  }, (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, scrollbarProps, {
    ref: composeRefs,
    style: {
      position: "absolute",
...
var $57acba87d6e25586$export$9fba1154677d7cd2 = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { forceMount, ...thumbProps } = props;
  const scrollbarContext = $57acba87d6e25586$var$useScrollbarContext($57acba87d6e25586$var$THUMB_NAME, props.__scopeScrollArea);
  return (0, import_react2.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || scrollbarContext.hasThumb
  }, (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaThumbImpl, _extends({
    ref: forwardedRef
  }, thumbProps)));
});
var $57acba87d6e25586$var$ScrollAreaThumbImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  const removeUnlinkedScrollListenerRef = (0, import_react2.useRef)();
  const debounceScrollEnd = $57acba87d6e25586$var$useDebounceCallback(() => {
...
var $57acba87d6e25586$export$56969d565df7cc4b = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$CORNER_NAME, props.__scopeScrollArea);
  const hasBothScrollbarsVisible = Boolean(context.scrollbarX && context.scrollbarY);
  const hasCorner = context.type !== "scroll" && hasBothScrollbarsVisible;
  return hasCorner ? (0, import_react2.createElement)($57acba87d6e25586$var$ScrollAreaCornerImpl, _extends({}, props, {
    ref: forwardedRef
  })) : null;
});
...
var $57acba87d6e25586$var$ScrollAreaCornerImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeScrollArea, ...cornerProps } = props;
  const context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$CORNER_NAME, __scopeScrollArea);
  const [width1, setWidth] = (0, import_react2.useState)(0);
  const [height1, setHeight] = (0, import_react2.useState)(0);
  ...
  return hasSize ? (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, cornerProps, {
    ref: forwardedRef,
    style: {
      width: width1,
      height: height1,
